...
/*   Updated: 2022/11/12 15:59:02 by cjimenez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	}
	{
		...
		try
		{
			Form form = Form("Super form", 43, 42);
			std::cout << "\e[0;32mWorked !\e[0m" << std::endl;
		}
		catch(const std::exception& e)
		{
		...
		try
		{
			Form form = Form("Super form", 55, 56);
			std::cout << "\e[0;32mWorked !\e[0m" << std::endl;
		}
		catch(const std::exception& e)
		{
		...
		try
		{
			Form form = Form("Super form", 60, 70);
			std::cout << "\e[0;32mWorked !\e[0m" << std::endl;
		}
		catch(const std::exception& e)
		{
		...
		try
		{
			Form form = Form("Super form", 50, 2);
			std::cout << "\e[0;32mWorked !\e[0m" << std::endl;
		}
		catch(const std::exception& e)
		{
